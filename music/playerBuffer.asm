...
flushVI:
    ...
    ld a,vCH : out (08),a;глушим канал
...
2:
    ...
    ld a,vCH + #40 : out (08),a;глушим канал
...
2:	
    ...
    ld a,vCH + #80 : out (08),a;глушим канал
...
mus_init	ld hl, music
			...
			IFDEF PLAY_VI53
				ld a,vCH : out (08),a;
				ld a,vCH+#40 : out (08),a;
				ld a,vCH+#80 : out (08),a;
			ENDIF
